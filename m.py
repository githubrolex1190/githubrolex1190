    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 121:
                ...
                response = f"BGMI Attack Finished. Target: {target} Port: {port} Port: {time} : By @ROLEX1173"
        else:
...
def show_command_logs(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "You Are Not Authorized To Use This Command Buy Access From @ROLEX1173😡."
